...
export default function EpisodeItem({ data }) {
    return <a href="https://www.youtube.com/embed/ScMzIvxBSi4" className="select-none flex flex-col rounded border p-4 bg-white hover:from-orange-400 hover:bg-gradient-to-l hover:to-red-500 hover:text-white  cursor-pointer space-y-2 " >
